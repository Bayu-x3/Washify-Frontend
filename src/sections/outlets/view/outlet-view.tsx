...
import { OutletTableRow } from '../outlet-table-row';
import { TableEmptyRows } from '../table-empty-rows';
import { OutletTableHead } from '../outlet-table-head';
import { OutletTableToolbar } from '../outlet-table-toolbar';
import { emptyRows, applyFilter, getComparator } from '../utils';

import type { OutletProps} from '../outlet-table-row';
...
export function OutletView() {
  ...
  const [users, setUsers] = useState<OutletProps[]>([]);
  ...
  const dataFiltered: OutletProps[] = applyFilter({
    inputData: users,
